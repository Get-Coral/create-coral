...
var ARCHIVE_URL = "https://codeload.github.com/Get-Coral/template/tar.gz/refs/heads/main";
var DEFAULT_ASSIGNEE = "ElianCodes";
var coral = "\x1B[38;5;209m";
var teal = "\x1B[38;5;80m";
var ink = "\x1B[97m";
var faint = "\x1B[90m";
var reset = "\x1B[0m";
var bold = "\x1B[1m";
...
async function main() {
  ...
  try {
    ...
    if (!isDirectoryEmpty(targetDir)) {
      const ok = options.yes ? false : await confirm(
        rl,
    ...
    try {
      ...
      const displayTargetDir = !relativeTargetDir || relativeTargetDir.startsWith("..") ? targetDir : relativeTargetDir;
      console.log(`
